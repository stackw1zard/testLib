...
public class FireBaseQuestionaires extends AppCompatActivity {
    ...
    ViewGroup insertPointJsonFiles, offlineBaseLayout, insertPoint;
...
//    private Menu mMenu;
    ...
    TextView response, mQuestionText, mQuestionHint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fire_questionaires);
        ...
        insertPointJsonFiles = findViewById(R.id.insert_point_json_files);
        mQuestionText = (TextView) findViewById(R.id.offline_question_text);
        mQuestionHint = (TextView) findViewById(R.id.offline_question_hint);
        insertPoint = findViewById(R.id.insert_point);

        mNextQuestion = findViewById(R.id.btn_next);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String text = "";
                //            str += (file[i].getName() + "\n");
                LayoutInflater inflater = FireBaseQuestionaires.this.getLayoutInflater();
                                    ...
                                    public void onSuccess(byte[] bytes) {
                                        ...
                                        mcqImage.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                Toast.makeText(FireBaseQuestionaires.this, " GOING TO FETCH: " + questionaire.getJsonUrl() + "  " + question_array.size(), Toast.LENGTH_LONG).show();
                                                insertPointJsonFiles.setVisibility(View.GONE);
                                                ((ViewGroup) findViewById(R.id.offline_question_view)).setVisibility(View.VISIBLE);
                                                ((ImageView) findViewById(R.id.btn_next)).setVisibility(View.VISIBLE);
                                            }
                                        });
...
//                                        imageView.setImageBitmap(bm);
                ...
                ((TextView) findViewById(R.id.fire_questionaires)).setText(text);
            }
...
// Load the sound
        ...
        soundIdFailure = soundPool.load(this, R.raw.failure, 1);
        soundIdStart = soundPool.load(this, R.raw.sound_starter, 1);
        soundIdGameover = soundPool.load(this, R.raw.thezero__game_over_sound, 1);
    }
...
//
            ...
            findViewById(R.id.offline_question_view).setVisibility(View.GONE);
            Toast.makeText(FireBaseQuestionaires.this, "THIS WAS LAST QUESTION", Toast.LENGTH_LONG).show();
        } else {
...
//        this.mMenu = menu;
//        MenuInterface.initMenu(menu, R.id.menuLeaderBoard);
//
//        menu.findItem(R.id.menuEdit).setVisible(false);
////        menu.findItem(R.id.menuStatus).setVisible(false);
//        menu.findItem(R.id.menuLogout).setVisible(false);
//        menu.findItem(R.id.dbQuestionaires).setVisible(false);
//
//        return true;
//    }
//
